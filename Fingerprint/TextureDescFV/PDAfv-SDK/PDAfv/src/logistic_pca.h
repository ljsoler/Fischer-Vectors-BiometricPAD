...
#define whiteningRegul 0
		...
		void train_model(unsigned char* descriptors, int numOfData, int dimension, int max_components, bool whitening, float** means, float** eigenvectors, float** eigenvalues);
	}
}
